...
If you use CLD Studio or the accompanying dataset in your own work, please cite it as:

> Mathis, B., Mielniczek, A., \& Boulet, S. (2026). \*CLD Studio: An interactive causal modeling tool for building, visualizing, and simulating Causal Loop Diagrams\* (Version 1.0.0) \[Software]. Zenodo. https://doi.org/10.5281/zenodo.22912800

BibTeX:

```bibtex
@software{mathis\_cld\_studio\_2026,
  author       = {Mathis, Benoit and Mielniczek, Alexandre and Boulet, Sylvain},
  title        = {CLD Studio: An interactive causal modeling tool for building, visualizing, and simulating Causal Loop Diagrams},
  year         = {2026},
  publisher    = {Zenodo},
  version      = {1.0.0},
  doi          = {10.5281/zenodo.22912800},
  url          = {https://doi.org/10.5281/zenodo.22912800}
}
```

Individual author Zenodo/ORCID identifiers:

* Benoit Mathis — Zenodo ID: 22912800
* Alexandre Mielniczek — ORCID: 0000-0001-8349-8956
* Sylvain Boulet — IDREF: 14924102X
